...
5. Include an execution loop, validation commands, progress logs, completion definition, and blocking rules.
6. Save the file to the user-specified path when provided. If no path is provided, ask for one or draft inline.
7. Verify that the file exists and briefly summarize what was created.
...
- It includes execution loop, phases, validation, progress logging, blocking rules, and completion definition.
